...
public class MainActivity extends Activity implements ScopeLogger{
    ...
    private static class createMainActivityHolder{
        public static final MainActivity MainActivityInstance = new MainActivity();
    }
    public static MainActivity getMainActivityInstance(){
        return createMainActivityHolder.MainActivityInstance;
    }
    */
    //singleton
